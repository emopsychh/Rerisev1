        ...
        "leads": [
          {
            ...
            "phone": "+79002145511",
            "contact": "@marina.ai",
            "note": "Интересуется AI Box для контента"
          }
        ]
      },
...
# 8. AI Box (дополнительно — не отдельный пункт меню, но нужен)
...
| AI Box | 5 | scenarios, sessions, messages |
...
| **E** | ibox/scenarios, sessions | AI Box |
